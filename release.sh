...
# Usage: ./release.sh 0.0.32-alpha
# Github Release push:
#  gh release create v0.0.32-alpha build/Canopy-0.0.32-alpha.zip build/appcast.xml --title "0.0.32-alpha" --notes "Thirty-second alpha release"
