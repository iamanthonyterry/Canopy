...
# Usage: ./release.sh 0.0.33-alpha
# Github Release push:
#  gh release create v0.0.33-alpha build/Canopy-0.0.33-alpha.zip build/appcast.xml --title "0.0.33-alpha" --notes "Thirty-third alpha release"
