...
# Usage: ./release.sh 0.0.11-alpha
# Github Release push: 
#  gh release create v0.0.11-alpha build/NetworkSync-0.0.11-alpha.zip build/appcast.xml --title "0.0.11-alpha" --notes "Eleventh alpha release"
