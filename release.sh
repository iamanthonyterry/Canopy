...
# Usage: ./release.sh 0.0.23-alpha
# Github Release push: 
#  gh release create v0.0.23-alpha build/NetworkSync-0.0.23-alpha.zip build/appcast.xml --title "0.0.23-alpha" --notes "Twenty-third alpha release"
