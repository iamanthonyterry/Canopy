...
# Usage: ./release.sh 0.0.24-alpha
# Github Release push: 
#  gh release create v0.0.24-alpha build/NetworkSync-0.0.24-alpha.zip build/appcast.xml --title "0.0.24-alpha" --notes "Twenty-fourth alpha release"
