...
# Usage: ./release.sh 0.0.18-alpha
# Github Release push: 
#  gh release create v0.0.18-alpha build/NetworkSync-0.0.18-alpha.zip build/appcast.xml --title "0.0.18-alpha" --notes "Eighteenth alpha release"
