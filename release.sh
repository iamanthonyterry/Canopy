...
# Usage: ./release.sh 0.0.29-alpha
# Github Release push:
#  gh release create v0.0.29-alpha build/Canopy-0.0.29-alpha.zip build/appcast.xml --title "0.0.29-alpha" --notes "Twenty-ninth alpha release"
