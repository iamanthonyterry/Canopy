...
# Usage: ./release.sh 0.0.27-alpha
# Github Release push:
#  gh release create v0.0.27-alpha build/Canopy-0.0.27-alpha.zip build/appcast.xml --title "0.0.27-alpha" --notes "Twenty-seventh alpha release"
