...
# Usage: ./release.sh 0.0.31-alpha
# Github Release push:
#  gh release create v0.0.31-alpha build/Canopy-0.0.31-alpha.zip build/appcast.xml --title "0.0.31-alpha" --notes "Thirty-first alpha release"
