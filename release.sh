...
# Usage: ./release.sh 0.0.37-alpha
# Github Release push:
#  gh release create v0.0.37-alpha build/Canopy-0.0.37-alpha.zip build/appcast.xml --title "0.0.37-alpha" --notes "Thirty-seventh alpha release"
