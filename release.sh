...
# Usage: ./release.sh 0.0.30-alpha
# Github Release push:
#  gh release create v0.0.30-alpha build/Canopy-0.0.30-alpha.zip build/appcast.xml --title "0.0.30-alpha" --notes "Thirtieth alpha release"
