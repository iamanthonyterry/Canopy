...
# Usage: ./release.sh 0.0.13-alpha
# Github Release push: 
#  gh release create v0.0.13-alpha build/NetworkSync-0.0.13-alpha.zip build/appcast.xml --title "0.0.13-alpha" --notes "Thirteenth alpha release"
