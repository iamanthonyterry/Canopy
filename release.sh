...
# Usage: ./release.sh 0.0.19-alpha
# Github Release push: 
#  gh release create v0.0.19-alpha build/NetworkSync-0.0.19-alpha.zip build/appcast.xml --title "0.0.19-alpha" --notes "Nineteenth alpha release"
